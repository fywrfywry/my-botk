...
# الاستماع لأي ملف يتم إرساله أو تحويله مباشرة للبوت
@client.on(events.NewMessage(incoming=True))
async def handle_document_messages(event):
    # التحقق مما إذا كانت الرسالة تحتوي على ملف (Document)
    ...
    msg = await event.respond(
        ...
        "----------------------------------\n"
        "⏳ **الحالة:** تم استلام الملف، جارٍ التنزيل...\n"
        "----------------------------------"
    )
    ...
    try:
        ...
        # تنزيل الملف المرسل أو المحول مباشرة
        await client.download_media(event.message, file=input_path, progress_callback=download_progress_callback)
...
if __name__ == '__main__':
    print("البوت يعمل الآن وجاهز لاستقبال الملفات مباشرة...")

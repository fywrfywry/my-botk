...
# ضع توكن البوت الخاص بك هنا مباشرة أو عبر متغيرات البيئة في ريلواي
BOT_TOKEN = os.getenv('BOT_TOKEN', 'ضع_توكن_البوت_هنا_إذا_لم تستخدم_Environment_Variables')

# إنشاء العميل باستخدام Bot Token ليعمل تلقائياً على السيرفر بدون تفاعل بشري
